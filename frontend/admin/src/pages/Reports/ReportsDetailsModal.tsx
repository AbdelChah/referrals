          ...
          <Box>
            ...
            >
              ...
              <Typography variant="body1" sx={{ color: "#555" }}>
                ...
                {campaign.reward_criteria.reward_amount}{" "}
                {campaign.reward_criteria.currency}
              </Typography>
              <Typography variant="body1" sx={{ color: "#555" }}>
                <strong>Onboarding Required:</strong>{" "}
                {campaign.reward_criteria.onBoarding ? "Yes" : "No"}
              </Typography>
            </Box>
            ...
            <Box>
              <Typography
                variant="h6"
                sx={{ marginBottom: "12px", color: "#333" }}
              >
              ...
              {campaign.referrers?.map((referrer: any) => (
                ...
                >
                  ...
                  <AccordionDetails
                    sx={{ backgroundColor: "#f0f4f7", padding: "16px" }}
                  >
                    <Typography variant="body2" sx={{ fontWeight: "bold" }}>
                      Referee List:
                    </Typography>
                    {referrer.referees?.length > 0 ? (
                      referrer.referees.map((referee: any) => (
                        ...
                        >
                          ...
                          <Typography variant="body2" sx={{ color: "#333" }}>
                            ...
                            {referee.status ? "Completed" : "Not Completed"}
                          </Typography>
                          <Typography variant="body2" sx={{ color: "#333" }}>
                            <strong>Start Date:</strong>{" "}
                            {new Date(referee.start_date).toLocaleString()}
                          </Typography>
                          <Typography variant="body2" sx={{ color: "#333" }}>
